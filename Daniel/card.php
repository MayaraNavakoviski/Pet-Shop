    ...
    <?php foreach ($animais as $animal): ?>
        <div class="bg-white shadow-lg rounded-lg w-80 p-4 m-4">
            ...
            <p class="text-gray-600">Sexo: 
                <?php   
                switch($animal['sexo']) {
                    case 'F': echo 'Fêmea'; break;
                    case 'M': echo 'Macho'; break;
                } 
                ?></p> 
            <p class="text-gray-600">Espécie: 
                <?php 
                switch($animal['especie']) {
                    case 'C': echo 'Cachorro'; break;
                    case 'G': echo 'Gato'; break;
                    case 'P': echo 'Pássaro'; break;
                    case 'Pe': echo 'Peixe'; break;
                    case 'R': echo 'Roedor'; break;
                    case 'Re': echo 'Réptil'; break;
                    default: echo $especie;
                }
            ?></p>
            <p class="text-gray-600">Serviço: 
                <?php 
                switch($animal['servico']) {
                    case 'B': echo 'Banho'; break;
                    case 'T': echo 'Tosa'; break;
                    case 'BT': echo 'Banho e Tosa'; break;
                    case 'C': echo 'Consulta'; break;
                }?></p>
